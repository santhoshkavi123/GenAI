...
import chatbot as demo  #**Import your Chatbot file as demo

#2 Set Title for Chatbot - https://docs.streamlit.io/library/api-reference/text/st.title
st.title("Hi, This is Chatbot Santhosh :Understanding Memory Concept in LangChain:") # **Modify this based on the title you want in want
...
input_text = st.chat_input("We are texting Langchain Memory") # **display a chat input box
if input_text: 
